...
use App\Models\S_Appl;
use App\Models\Listing;
use App\Models\S_Group;
use App\Models\Group_Appl;
use App\Models\S_Appl_Group;
use Illuminate\Database\Seeder;
use Illuminate\Support\Facades\DB;

class SApplSeeder extends Seeder
{
    /**
    ...
    {
        $this->s_appl_seeder();
        $this->s_appl_group_seeder();
        $this->s_group_seeder();
        $this->s_group_appl_seeder();
    }

    private function s_appl_seeder() 
    {
        ...
        S_Appl::insert($defaultApplGroup);
    }

    private function s_appl_group_seeder() 
    {
        ...
        S_Appl_Group::insert($defaultApplGroup);
    }

    private function s_group_seeder() 
    {
        ...
        S_Group::insert($defaultUserGroup);
    }

    private function s_group_appl_seeder() 
    {
        $defaultRole = array(
            'VIEW',
            'ADD',
        ...
        Group_Appl::insert($defaultUserGroup);
    }
}
