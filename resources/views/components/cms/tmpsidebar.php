            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                ...
                <div class="menu-item">
                    <div class="menu-content pt-8 pb-2">
                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">General Settings</span>
                    </div>
                </div>
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link" href="apps/customers/getting-started.html">
                                ...
                                <span class="menu-title">Create New Listing</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="apps/customers/list.html">
                                ...
                                <span class="menu-title">Show All Listing</span>
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link" href="apps/customers/getting-started.html">
                                ...
                                <span class="menu-title">Create New Stories</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="apps/customers/list.html">
                                ...
                                <span class="menu-title">Show All Stories</span>
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link" href="apps/customers/getting-started.html">
                                ...
                                <span class="menu-title">Show All Subscribers</span>
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="layouts/toolbars/toolbar-2.html">
                                ...
                                <span class="menu-title">Show All User</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="layouts/toolbars/toolbar-3.html">
                                ...
                                <span class="menu-title">Create New User Group</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="layouts/toolbars/toolbar-4.html">
                                ...
                                <span class="menu-title">Show All User Group</span>
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link" href="layouts/aside/light.html">
                                ...
                                <span class="menu-title">Create New Categories</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="layouts/aside/minimized.html">
                                ...
                                <span class="menu-title">Show All Categories</span>
                            </a>
                        </div>
                    </div>
                </div>
