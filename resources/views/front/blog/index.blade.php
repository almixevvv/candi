...
<div class="container-fluid px-0">
        ...
        <div id="slider" class="section-scrollable" data-flickity='{ "cellAlign": "left", "contain": true, "pageDots": false, "wrapAround": true }'>	            
            @foreach($featuredBlogs as $featuredBlog)
                <div class="section-featured is-featured-image">
                    <div class="featured-image" style="border-radius: 25px;background-image: url('{{ $featuredBlog->image->image_url }}')"></div>
                    <div class="featured-wrap flex">
                        <article class="featured-content">
                            <span class="featured-label global-tag" style="color: #ffffff;background-color: #50e7e0;font-weight: bold;">
    ...
    <div class="page blog-list-page full-width" style="padding-left: 5.5rem !important; padding-right: 5.5rem !important;">
      <div id="loop" class="section-loop blog-wrap" style="margin-top: 0; margin: 0;">
          <div class="items-wrap flex loop-first">
              @foreach($blogCategories as $blogCategory)
                @if (count($blogCategory->blogs))
                  <div class="item-wrap flex post tag-story tag-hash-orange tag-hash-post-orange tag-hash-cta-violet no-image " style="min-width: 450px">
                      <article style="background-image: none">
