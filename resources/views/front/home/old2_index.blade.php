                ...
                <div class="wrap_float">
                    ...
                    <div class="section_content">
                        <div class="scroll">
                            ...
                            <a href="{{ route('detail_directory') }}" class="destinations_item" style="background-image: url(https://images.unsplash.com/photo-1481833761820-0509d3217039?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Y2FmZXxlbnwwfHwwfHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60)">
                                <div class="sq_parent">
                                    <div class="sq_wrap">
                                        <div class="sq_content">
                                            <div class="_content">
                            ...
                            <a href="{{ route('detail_directory') }}" class="destinations_item" style="background-image: url(https://1.bp.blogspot.com/-VZ3uTgwvAfU/XzTiL2ZXg9I/AAAAAAAB08Q/MSLIunQhIdYLNgFgdXgASf6t9ecaWd0zACLcBGAsYHQ/s1080/Resep%2BAyam%2BBakar%2BKecap.jpeg)">
                                <div class="sq_parent">
                                    <div class="sq_wrap">
                                        <div class="sq_content">
                                            <div class="_content">
                            ...
                            <a href="{{ route('detail_directory') }}" class="destinations_item" style="background-image: url(https://www.unileverfoodsolutions.co.id/dam/global-ufs/mcos/SEA/calcmenu/recipes/ID-recipes/rice-dishes/nasi-kuning/main-header.jpg)">
                                <div class="sq_parent">
                                    <div class="sq_wrap">
                                        <div class="sq_content">
                                            <div class="_content">
                            ...
                            <a href="{{ route('detail_directory') }}" class="destinations_item" style="background-image: url(https://akcdn.detik.net.id/community/media/visual/2019/08/02/c688a5f4-adc7-4734-84a7-2b757db02f62.jpeg?w=700&q=90)">
                                <div class="sq_parent">
                                    <div class="sq_wrap">
                                        <div class="sq_content">
                                            <div class="_content">
                            ...
                            <a href="{{ route('detail_directory') }}" class="destinations_item" style="background-image: url(https://assets-pergikuliner.com/E-oUHL_lTuLK72r5eKG6sd2inIg=/385x290/smart/https://assets-pergikuliner.com/uploads/image/picture/1544282/picture-1566278812.jpg)">
                                <div class="sq_parent">
                                    <div class="sq_wrap">
                                        <div class="sq_content">
                                            <div class="_content">
